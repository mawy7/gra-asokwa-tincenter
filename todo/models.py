...
from entry.models import Organization
...
class Task(models.Model):
    ...
    no_of_assigned_task = models.CharField(default='',max_length=10, blank=True, null=True)
    completed = models.BooleanField(default=False)
    completed_date = models.DateField(default=date.today, blank=True, null=True)
    ...
    organization = models.ForeignKey(Organization, default="", help_text="What is the name of the Organization", max_length=100, on_delete=models.CASCADE)
    time_of_completion = models.DateField(default=date.today, blank=True, null=True)
